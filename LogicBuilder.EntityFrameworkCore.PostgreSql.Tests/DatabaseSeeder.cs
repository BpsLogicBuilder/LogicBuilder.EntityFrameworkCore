...
using LogicBuilder.EntityFrameworkCore.PostgreSql.Tests.Models.Repositories;
using System;
...
namespace LogicBuilder.EntityFrameworkCore.PostgreSql.Tests
{
    internal static class DatabaseSeeder
    {
        ...
        internal static async Task Seed_Database(ISchoolRepository repository)
        {
            ...
            [
                new InstructorModel { FirstName = "Roger",   LastName = "Zheng", HireDate = DateTime.SpecifyKind(DateTime.Parse("2004-02-12", CultureInfo.CurrentCulture), DateTimeKind.Utc), EntityState = LogicBuilder.Domain.EntityStateType.Added },
                new InstructorModel { FirstName = "Kim", LastName = "Abercrombie", HireDate = DateTime.SpecifyKind(DateTime.Parse("1995-03-11", CultureInfo.CurrentCulture), DateTimeKind.Utc), EntityState = LogicBuilder.Domain.EntityStateType.Added},
                new InstructorModel { FirstName = "Fadi", LastName = "Fakhouri", HireDate = DateTime.SpecifyKind(DateTime.Parse("2002-07-06", CultureInfo.CurrentCulture), DateTimeKind.Utc), OfficeAssignment = new OfficeAssignmentModel { Location = "Smith 17" }, EntityState = LogicBuilder.Domain.EntityStateType.Added},
                new InstructorModel { FirstName = "Roger", LastName = "Harui", HireDate = DateTime.SpecifyKind(DateTime.Parse("1998-07-01", CultureInfo.CurrentCulture), DateTimeKind.Utc), OfficeAssignment = new OfficeAssignmentModel { Location = "Gowan 27" }, EntityState = LogicBuilder.Domain.EntityStateType.Added },
                new InstructorModel { FirstName = "Candace", LastName = "Kapoor", HireDate = DateTime.SpecifyKind(DateTime.Parse("2001-01-15", CultureInfo.CurrentCulture), DateTimeKind.Utc), OfficeAssignment = new OfficeAssignmentModel { Location = "Thompson 304" }, EntityState = LogicBuilder.Domain.EntityStateType.Added }
            ];
