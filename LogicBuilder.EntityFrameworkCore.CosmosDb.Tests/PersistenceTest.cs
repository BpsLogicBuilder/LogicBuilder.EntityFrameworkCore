...
using LogicBuilder.EntityFrameworkCore.CosmosDb.Tests.Crud.DataStores;
...
namespace LogicBuilder.EntityFrameworkCore.CosmosDb.Tests
{
    public class PersistenceTest : IClassFixture<DatabaseFixture>
    {
        ...
        public async Task CanUpdateAChildObjectThenDeleteIt()
        {
            ...
            Assert.Null(instructor3.OfficeAssignment!.Location);
            Assert.Null(instructor3.OfficeAssignment!.InstructorID);
            Assert.True(success);
        }
